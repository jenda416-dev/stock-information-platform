  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <div className="bg-card rounded-xl border border-border p-4 space-y-3">
        <p className="text-[11px] font-mono text-muted-foreground mb-2">Skeleton</p>
      ...
      <div className="bg-card rounded-xl border border-border p-4 flex items-center justify-center">
        <div className="text-center">
          <p className="text-[11px] font-mono text-muted-foreground mb-3">Loading Text</p>
      ...
      <div className="bg-card rounded-xl border border-border p-4 flex items-center justify-center min-h-[100px]">
        <div className="text-center">
          <p className="text-[11px] font-mono text-muted-foreground mb-3">Empty State</p>
